  ...
  const panes = [
    {
      ...
      render: () => (
        <Tab.Pane attached={false}>
          ...
          <Button content='Proceed' onClick={handleRangeChange} value={1} />
        </Tab.Pane>
      )
    },
    {
      ...
      render: () => (
        <Tab.Pane attached={false}>
          ...
          <Button content='Proceed'       className='float-right'
        color='pink' onClick={handleRangeChange} value={2} />
        </Tab.Pane>
      )
    },
    {
      ...
      render: () => (
        <Tab.Pane attached={false}>
          ...
          <Button content='Submit' onClick={handleSubmitProfile} />
        </Tab.Pane>
      )
    }
  ];
