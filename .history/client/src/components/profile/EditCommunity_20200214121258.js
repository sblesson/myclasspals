...
import ProfileModal from './school/modal/AddSchoolModal';
import EditSchoolModal from './school/modal/EditSchoolModal';
import DeleteSchoolModal from './school/modal/DeleteSchoolModal';
...
const EditCommunity = ({ community }) => {
  const schools = school.map(schoolItem => (
    <div className='profile-content-details' key={schoolItem._id}>
      <EditSchoolModal schoolItem={schoolItem} />
