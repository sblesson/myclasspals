  ...
  const panes = [
    ...
    },
    {
      ...
      render: () => (
        <Tab.Pane attached={false}>
          <article>
            Welcome to your child\'s school community. Your first post to making a difference is just a minute away. Click on     <Link to='/dashboard' className='btn btn-primary my-1'>
                  Go to 
                </Link>
          </article>
        </Tab.Pane>
