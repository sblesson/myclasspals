...
const Account = ({ auth }) => {
  ...
  const userDetails = (
    <div className='profile-content-details' key={auth.user._id}>
      ...
      <div className='user-info-item'>
        <div className='user-info-content'>{userData.username} </div>
      </div>
      <div className='user-info-item'>
      ...
      <div className='user-info-item'>
        ...
        Download SVGPerfect for when you want to use just one icon as a vector
        on the desktop or in your own icon workflow.
