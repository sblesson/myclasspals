  ...
  const panes = [
    {
      ...
      render: () => (
        <Tab.Pane attached={false}>
          <ContactForm user={createProfileData.user} />
        </Tab.Pane>
      )
    },
    {
      ...
      render: () => (
        <Tab.Pane attached={false}>
          <AddChildForm community={createProfileData.community} />
        </Tab.Pane>
      )
    },
    {
      ...
      render: () => (
        <Tab.Pane attached={false}>
          <WelcomeForm isAcceptedTandC={createProfileData.isAcceptedTandC} />
          <Form.Field
            control={Button}
