...
const ProfileModal = ({
  ...
  const resultRenderer = ({ schoolName, city }) => (
    ...
    <div class="result">
      <div class="image"><img src="https://s3.amazonaws.com/uifaces/faces/twitter/gcmorley/128.jpg"></div>
      <div class="content"><div class="price">$60.49</div><div class="title">Feeney LLC</div><div class="description">Digitized neutral artificial intelligence</div></div></div>
  );
