  ...
  return (
    <div>
      ...
      <Modal isOpen={modal} fade={false} toggle={toggle}>
        ...
        <ModalBody>
          {
            "Are you sure you want to delete your child\'s current school community? You won't be able to access this community after this action. You can create new one by clicking ''"
          }
        </ModalBody>
        <ModalFooter>
          <Button
