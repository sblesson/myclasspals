...
const PostItem = ({
  ...
  deletePost,
  auth,
  post: { _id, subject, message, name, avatar, user, likes, thanks, comments, date },
  showActions
}) => (
  <div className='post bg-white p-1'>
    ...
    <div className='post-message-container'>
      <Link to={`/posts/${_id}`} className='post-message-title-container'>
        <h5 className='post-heading'>Looking for Indian cook</h5>
      </Link>

      <p className='my-1 post-message'>{subject}</p>
