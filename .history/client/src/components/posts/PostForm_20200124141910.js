  ...
  return (
    <div>
      ...
      <Modal isOpen={modal} fade={false} toggle={toggle}>
        ...
        <ModalBody>
          <Form>
            <FormGroup tag='fieldset' className='post-field'>
              <legend className='col-form-label'>Choose topics</legend>
              <div className='post-field-radio-options-container'>
            ...
            <FormGroup tag='fieldset' className='post-form'>
            ...
            <FormGroup className='post-field'>
              <Input
                className='post-post-form-field-text-input'
                type='text'
                name='subject'
                placeholder='Subject'
                onChange={e => onChange(e)}
            ...
            <FormGroup className='post-field'>
              <textarea
                className='post-field-text-input post-field-textarea'
                name='message'
                cols='30'
                rows='5'
